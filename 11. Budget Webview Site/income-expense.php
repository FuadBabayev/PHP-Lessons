...
<body class=" bg-light">
    <div class="container-fluid p-0 " id="home">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="./expense-add.php" class="btn btn-outline-secondary w-100 btn-lg"><i class="bi bi-dash"></i>Gider Ekle</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="alert alert-" role="alert">
            ...
            <p>Gelir ve Gider kategorilerinize ekleme ve çıkarma işlemi yapabilirsiniz.</p><hr>
