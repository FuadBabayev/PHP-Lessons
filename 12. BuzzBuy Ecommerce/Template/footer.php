			...
			<div class="row">
				...
				<div class="col-md-4"><!--footer contact widget-->
					...
					<ul class="contact-widget">
						<li class="fphone"><?php echo $read_title['phone']; ?><br><?php echo $read_title['fax']; ?></li>
						<li class="fmobile"><?php echo $read_title['gsm']; ?></li>
						<li class="fmail lastone"><?php echo $read_title['email']; ?></li>
					</ul>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="f-credit">&copy;All rights reserved by <a href="#"><?php echo $read_title['author'] ?></a></div>
				...
				<div class="col-md-3"><!--footer Share-->
					...
					<div class="fsoc">
						<a href="http://<?php echo $read_title['twitter'] ?>" class="ftwitter">twitter</a>
						<a href="http://<?php echo $read_title['facebook'] ?>" class="ffacebook">facebook</a>
						<a href="http://<?php echo $read_title['google'] ?>" class="fflickr">google</a>
						<a href="http://<?php echo $read_title['youtube'] ?>" class="ffeed">youtube</a>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
				</div><!--footer Share-->
